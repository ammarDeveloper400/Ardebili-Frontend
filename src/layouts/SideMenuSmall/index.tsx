...
import { selectSideMenu } from "../../stores/sideMenuSliceSmall";
...
function Menu(props: {
  ...
  return (
    <SideMenuTooltip
      ...
      className={clsx([
        "h-[50px] flex items-center pl-5 text-slate-600 mb-1 relative rounded-xl dark:text-slate-300",
        {
          ...
          "bg-primary-custom dark:bg-transparent":
            props.menu.active && props.level == "first",
    ...
    >
      <div
        className={clsx({
          "text-custom-white z-10 dark:text-slate-300":
            props.menu.active && props.level == "first",
      ...
      <div
        className={clsx([
          ...
          {
            "text-custom-white font-medium z-10 dark:text-slate-300":
              props.menu.active && props.level == "first",
