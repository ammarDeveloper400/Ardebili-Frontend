...
function Discipline() {
    ...
    const save_department = async () =>{
      ...
      setLoading(true);
      const {isError, data} = await doPost(payload, 'add_new_services');
      if(isError) {
          toast.error('Something went wrong with server.');
          setLoading(false);
      }else{
    ...
    const update_discipline = async () =>{
      ...
      setLoading(true);
      const {isError, data} = await doPost(payload, 'update_services');
      if(isError) {
          toast.error('Something went wrong with server.');
          setLoading(false);
      }else{
    ...
    const delete_department = async () =>{
      ...
      setLoading(true);
      const {isError, data} = await doPost(payload, 'delete_services');
      setLoading(false);
      if(isError) {
          toast.error('Something went wrong with server.');
          setLoading(false);
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">All Services</h2>
        ...
        <Dialog.Panel>
          <div className="p-5 text-center">
            ...
            <div className="mt-2 text-slate-500">
              Do you really want to delete this Standard Service? <br />
            ...
            <Dialog.Panel>
                <Dialog.Title>
                    <h2 className="mr-auto text-base font-medium">
                        {editid!=null?"Update Service":"Add New Service"}
                    </h2>
                </Dialog.Title>
